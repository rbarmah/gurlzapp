...
export default function ChatCard({
 ...
 const canLike = user && !likedBy.includes(user.id);
 ...
 return (
   <div 
     onClick={onClick}
     className={`${color} w-full p-6 rounded-xl text-left transition-all hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-white/20 cursor-pointer`}
   >
     {/* Header */}
